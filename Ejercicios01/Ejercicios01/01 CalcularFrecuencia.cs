...
namespace Ejercicios01
{
	...
	class CalcularFrecuencia : ICalcularFrecuencia
	{
		...
		{
			var palabras = frase.Split( " " ).Where( i => i.Length > 3 );
		...
		public IEnumerable<string> Palabras() => contar.Keys;
	...
	class DemoCalcularFrecuencia
	{
		static void Main( string[] args )
		{
			Console.WriteLine("* DEMO Cálculo de Frecuencias de palabras *\n");
